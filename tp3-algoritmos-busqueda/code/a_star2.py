        ...
        for action, (dr, dc) in actions.items():
            ...
            if 0 <= new_row < rows and 0 <= new_col < cols:
                ...
                if desc[new_row, new_col] != b'H':
                    ...
                    heapq.heappush(prior_queue ,(cost+cost_action+h((new_row,new_col), end_pos),((new_row, new_col), new_path)))
...
def executeA_star(env,seed):
        ...
        if path == None:
            ...
            print(f"A*_esc2,{seed},{len(visited)},{0},{0},{end-start},False")
            return
        ...
        print(f"A*_esc2,{seed},{len(visited)},{count_actions},{cost},{end-start},{finish}")
